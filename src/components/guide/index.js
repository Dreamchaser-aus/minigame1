    ...
    return (
      <div style={{ display: this.state.isMobile ? 'none' : 'block' }}>
        ...
        <div className={`${style.guide} ${style.left}`}>
          <p>
            <a href="https://sonicau.com" rel="noopener noreferrer" target="_blank" title={i18n.linkTitle[lan]}>{`${i18n.github[lan]}:`}</a><br />
            <iframe
              src="https://sonicau.com&type=star&count=true"
              frameBorder="0"
              scrolling="0"
              width="170px"
              height="20px"
            ...
            <br />
            <iframe
              src="https:/sonicau.com&type=fork&count=true"
              frameBorder="0"
              scrolling="0"
              width="170px"
              height="20px"
